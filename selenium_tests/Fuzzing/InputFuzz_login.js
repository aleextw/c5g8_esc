...
async function test() {
    ...
    await driver.findElement(By.name("loginUsernameInput")).sendKeys(alphabetFuzz());
    await driver.findElement(By.name("loginPasswordInput")).sendKeys(alphabetFuzz());


    let submitButton = driver.findElement(By.name("loginSubmitButton"));
