...
async function test(){
    ...
    await driver.get("http://localhost:3000/hotel?hotel_uid=WaXd&destination=Singapore,%20Singapore&dest_uid=RsBU&checkInDate=2022-07-24&checkOutDate=2022-07-25&numRooms=1&numAdults=2&numChildren=0&currency=SGD");
